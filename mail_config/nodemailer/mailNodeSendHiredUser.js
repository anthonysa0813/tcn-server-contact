...
async function mailNodeSendHiredUser(email, name, titleCampaign, whatsapp) {
  ...
  try {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: "Hola, ¡haz sido contratado!",
      html: `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
<!--[if mso]>
  ...
  <tr>
    ...
    <div class="name">
      ...
      <tr>
           <td>
          <strong>Whatsapp:</strong><a href="${whatsapp}" target="_blank" style="font-size: 17px;font-weight: bold;text-decoration: none;color: #1e5d7b;background-color: #EFF8FE;border:1px solid #EFF8FE;border-radius:10px;padding:12px 20px;display: inline-block;margin: 0 0 0 30px">
